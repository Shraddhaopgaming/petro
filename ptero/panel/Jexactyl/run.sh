...
install_panel() {
    ...
    bash <(curl -fsSL https://raw.githubusercontent.com/MrRangerXD/Ptero/refs/heads/main/ptero/panel/Jexactyl/install.sh)
...
while true; do
  ...
  case $choice in
    ...
    3)
       ...
       ;; 
    4)
       bash <(curl -fsSL https://raw.githubusercontent.com/MrRangerXD/Ptero/refs/heads/main/ptero/panel/Jexactyl/Migration.sh)
       ;;
    0) 
